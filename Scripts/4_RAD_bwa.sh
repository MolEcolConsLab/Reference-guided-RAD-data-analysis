...
REF=/nl/uma_lisa_komoroske_sandbox/Water_vole/ref-guided/reference_genome/GCA_903992535.1_mArvAmp1.1_genomic.fna #change this to be path to your reference genome file
